...
#   the wires together, which can be detected on a remote station. The Morse code encodes 
#   every character being transmitted as a sequence of "dots" (short presses on the key) 
...
#   transmit a single character, a skilled professional can transmit 60 words per minute, and 
#   robotic transmitters may go way faster.
...
#   down), 1 is recorded, and if the line is not connected (remote key is up), 0 is recorded. 
#   After the message is fully received, it gets to you for decoding as a string containing only 
#   symbols 0 and 1.
...
#   Function decodeMorse(morseCode), that would take the output of the previous function and return a }
#       human-readable string.
# NOTE: For coding purposes you have to use ASCII characters . and -, not Unicode characters.
# The Morse code table is preloaded for you as MORSE_CODE dictionary; 
#   in Java MorseCode class is provided; 
#   in Haskell the codes are in a Map String String and can be accessed like this:
#       morseCodes ! ".--" - feel free to use it.
# All the test strings would be valid to the point that they could be reliably decoded as described above, 
#   so you may skip checking for errors and exceptions, just do your best in figuring out what the message 
#   is!
# Good luck!
...
#···· · −·−− ·−−− ··− −·· · 
#1100110011001100000011000000111111001100111111001111110000000000000011001111110011111100111111000000110011001111110000001111110011001100000011
# 0000001 = '   '   | Pause between words – is 7 time units long.
# 00 = ' '          | Pause between characters inside a word – is 3 time units long.
